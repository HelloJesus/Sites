window.onload = function () {
    ...
    icons.onclick = function (event) {
        ...
        const icon4 = document.querySelector('.sweets'); // третья категория товара
        ...
        switch (iconIdAttr) {
            case "icon-1":
                ...
                // if (icon1.getBoundingClientRect().left < 0) {
            ...
            case "icon-2":
                ...
                // if (icon2.getBoundingClientRect().left > icon2.offsetWidth) {
